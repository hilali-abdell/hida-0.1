...
import SearchResult2 from "@/components/shared/SearchResult2";
import UserCard from "@/components/shared/UserCard";
import { Input } from "@/components/ui/input";
import useDebounce from "@/hooks/useDebounce";
import {  useGetUserss,  useSearchUsers } from "@/lib/react-query/queriesAndMutations";
        ...
        />
          ...
          {users.pages[0]?.documents.length === 0 ? (
            ...
            users.pages[0]?.documents.map((item, index) => (
              <li key={`page-${index}`} className="flex-1 min-w-[200px] w-full">
                <UserCard user={item} />
              </li>
            ))
          )}
